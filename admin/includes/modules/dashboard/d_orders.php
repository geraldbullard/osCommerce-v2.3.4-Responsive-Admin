  ...
  class d_orders {
    ...
    function getOutput() {
      ...
      $output = '<div class="table-responsive brtr3 brtl3">' .
                ...
                '        <th class="hide-below-480">' . MODULE_ADMIN_DASHBOARD_ORDERS_TOTAL . '</th>' .
                '        <th class="hide-below-480">' . MODULE_ADMIN_DASHBOARD_ORDERS_DATE . '</th>' .
                '        <th class="text-right width-action-below-768">' . MODULE_ADMIN_DASHBOARD_ORDERS_ORDER_STATUS . '</th>' .
                '      </tr>' .
                '    </thead>' .
                '    <tbody>';
      ...
      while ($orders = tep_db_fetch_array($orders_query)) {
        $output .= '      <tr class="dataTableRow" onmouseover="rowOverEffect(this);" onmouseout="rowOutEffect(this);">
                            ...
                            <td class="hide-below-480">' . strip_tags($orders['order_total']) . '</td>
                            <td class="hide-below-480">' . tep_date_short($orders['date_last_modified']) . '</td>
                            <td class="text-right width-action-below-768">' . $orders['orders_status_name'] . '</td>
                          </tr>';
      }
