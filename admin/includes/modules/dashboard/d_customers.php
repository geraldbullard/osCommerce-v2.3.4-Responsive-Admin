  ...
  class d_customers {
    ...
    function getOutput() {
      $output = '<div class="table-responsive brtr3 brtl3">' .
                ...
                '        <th class="text-right width-action-below-768">' . MODULE_ADMIN_DASHBOARD_CUSTOMERS_DATE . '</th>' .
                '      </tr>' .
                '    </thead>' .
                '    <tbody>';
      ...
      while ($customers = tep_db_fetch_array($customers_query)) {
        $output .= '      <tr onmouseover="rowOverEffect(this);" onmouseout="rowOutEffect(this);">
                            ...
                            <td class="text-right width-action-below-768">' . tep_date_short($customers['customers_info_date_account_created']) . '</td>
                          </tr>'; 
      }
